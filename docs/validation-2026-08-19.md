# Manual validation — v0.1.0-rc.1

**Status: in progress** — this record was opened when the release candidate was
prepared and is filled in by the maintainer's hands-on walkthrough before the
final `v0.1.0` is tagged (see [release-process.md — Cutting the first
release](release-process.md#cutting-the-first-release)). Until a platform's
section below is complete, that platform is *built and CI-tested*, not
validated by hand.
...
**Release under test**: `v0.1.0-rc.1`
**Validated by**:
**Date**:
